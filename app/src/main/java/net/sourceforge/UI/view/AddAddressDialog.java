...
public class AddAddressDialog extends Dialog implements View.OnClickListener{
    ...
    public AddAddressDialog(Context context, IOnProtocolDialogClickListener iOnProtocolDialogClickListener) {
    ...
    public AddAddressDialog(Context context, int themeResId) {
        super(context, themeResId);
        initDialogAttrs(context);
    }

    protected AddAddressDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void initDialogAttrs(Context paramContext)
    {
        ...
        setContentView(R.layout.layout_dialog_add_address);
