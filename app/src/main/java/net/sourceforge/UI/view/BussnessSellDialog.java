...
public class BussnessSellDialog extends Dialog implements View.OnClickListener{
    ...
    public BussnessSellDialog(Context context, IOnProtocolDialogClickListener iOnProtocolDialogClickListener) {
    ...
    public BussnessSellDialog(Context context, int themeResId) {
        super(context, themeResId);
        initDialogAttrs(context);
    }

    protected BussnessSellDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void initDialogAttrs(Context paramContext)
    {
        ...
        setContentView(R.layout.layout_dialog_bussness_sell);
