...
public class AddOtcAccountDialog extends Dialog implements View.OnClickListener{
    ...
    public AddOtcAccountDialog(Context context, IOnProtocolDialogClickListener iOnProtocolDialogClickListener) {
    ...
    public AddOtcAccountDialog(Context context, int themeResId) {
        super(context, themeResId);
        initDialogAttrs(context);
    }

    protected AddOtcAccountDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void initDialogAttrs(Context paramContext)
    {
        ...
        setContentView(R.layout.layout_dialog_otc_add_account);
