...
public class FragmentTransZZ extends FragmentBase {

    public static final String TAG = FragmentTransZZ.class.getSimpleName();
    ...
    public static FragmentTransZZ newInstance() {
        FragmentTransZZ f = new FragmentTransZZ();
        return f;
    }
