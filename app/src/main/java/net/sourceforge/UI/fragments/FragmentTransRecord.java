...
public class FragmentTransRecord extends FragmentBase {

    public static final String TAG = FragmentTransRecord.class.getSimpleName();
    ...
    public static FragmentTransRecord newInstance() {
        FragmentTransRecord f = new FragmentTransRecord();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        curView = inflater.inflate(R.layout.layout_trans_record, null);
