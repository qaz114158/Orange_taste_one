...
public class FragmentBussiness extends FragmentBase {

    public static final String TAG = FragmentBussiness.class.getSimpleName();
    ...
    public static FragmentBussiness newInstance() {
        FragmentBussiness f = new FragmentBussiness();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        curView = inflater.inflate(R.layout.layout_bussiness, null);
