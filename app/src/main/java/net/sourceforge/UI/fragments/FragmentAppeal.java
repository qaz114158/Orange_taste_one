...
public class FragmentAppeal extends FragmentBase {

    public static final String TAG = FragmentAppeal.class.getSimpleName();
    ...
    public static FragmentAppeal newInstance() {
        FragmentAppeal f = new FragmentAppeal();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        curView = inflater.inflate(R.layout.layout_appeal, null);
