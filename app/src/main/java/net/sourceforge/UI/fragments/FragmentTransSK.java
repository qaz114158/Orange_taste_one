...
public class FragmentTransSK extends FragmentBase {

    public static final String TAG = FragmentTransSK.class.getSimpleName();
    ...
    public static FragmentTransSK newInstance() {
        FragmentTransSK f = new FragmentTransSK();
        return f;
    }
